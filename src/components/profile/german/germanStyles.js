// Estilos personalizados de Germán
...
export const germanStyles = {
  ...
  profileHeader: {
    background: "linear-gradient(135deg, #f093fb 0%, #f5576c 100%)", // Cambia estos colores
    padding: "4rem 2rem",
    textAlign: "center",
    color: "white"
  },
  ...
  sectionTitle: {
    ...
    fontWeight: "bold",
    marginBottom: "1rem",
    color: "#f5576c" // Cambia este color para que combine con tu header
  },
  ...
  skillBadge: {
    background: "linear-gradient(135deg, #f093fb 0%, #f5576c 100%)", // Igual que el header
    color: "white",
  ...
  cardTitle: {
    ...
    fontWeight: "bold",
    marginBottom: "0.5rem",
    color: "#f5576c" // Cambia para que combine con tu tema
  },
