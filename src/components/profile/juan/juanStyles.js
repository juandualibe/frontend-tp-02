...
export const juanStyles = {
  ...
  profileHeader: {
    background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", // Cambia estos colores
    padding: "4rem 2rem",
    textAlign: "center",
    color: "white"
  },
  ...
  sectionTitle: {
    ...
    fontWeight: "bold",
    marginBottom: "1rem",
    color: "#667eea" // Cambia este color para que combine con tu header
  },
  ...
  skillBadge: {
    background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", // Igual que el header
    color: "white",
  ...
  cardTitle: {
    ...
    fontWeight: "bold",
    marginBottom: "0.5rem",
    color: "#667eea" // Cambia para que combine con tu tema
  },
